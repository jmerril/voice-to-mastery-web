...
const HowItWorks = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="pt-20">
        {/* Enhanced Hero Section with Tech Workflow Background */}
        <section className="relative py-32 px-4 overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 opacity-20">
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#3b82f6_1px,transparent_1px),linear-gradient(to_bottom,#3b82f6_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
          </div>
          
          {/* Floating Elements */}
          <div className="absolute inset-0 z-10">
            <div className="absolute top-20 left-10 w-32 h-32 bg-blue-400/20 rounded-full blur-xl animate-pulse"></div>
            <div className="absolute bottom-32 right-20 w-24 h-24 bg-purple-400/30 rounded-full blur-lg animate-bounce"></div>
            <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-cyan-400/25 rounded-full blur-md animate-pulse delay-500"></div>
            <div className="absolute top-1/4 right-1/4 w-20 h-20 bg-green-400/20 rounded-full blur-lg animate-pulse delay-700"></div>
            
            {/* Floating Particles */}
            <div className="absolute top-16 left-16 w-2 h-2 bg-white/30 rounded-full animate-bounce delay-300"></div>
            <div className="absolute top-24 right-24 w-1 h-1 bg-white/40 rounded-full animate-bounce delay-1000"></div>
            <div className="absolute bottom-24 left-24 w-1.5 h-1.5 bg-white/25 rounded-full animate-bounce delay-700"></div>
          </div>
          ...
          <div className="max-w-7xl mx-auto relative z-20">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-8 animate-fade-in">
